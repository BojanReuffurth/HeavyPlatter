import Foundation
struct CSVExporter {
    static let cols = ["artist","album","year","genre","label","format",
    ...
    private static func row(_ r: Record, _ df: DateFormatter) -> String {
        [r.artist,r.album,r.year,r.genre,r.label,r.format,r.country,r.condition,r.notes,
         df.string(from: r.dateAdded),
